...
class NativeLibrary {
  ...
  /// @brief Send an Output report to a HID device.
  ///
  /// Since version 0.15.0, @ref HID_API_VERSION >= HID_API_MAKE_VERSION(0, 15, 0)
  ///
  /// This function is similar to hid_write(), but it explicitly sends
  ...
  int hid_send_output_report(
    ...
    return _hid_send_output_report(
      dev,
      data,
      length,
    );
  ...
  late final _hid_send_output_reportPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<hid_device>,
              ffi.Pointer<ffi.UnsignedChar>,
              ffi.Size)>>('hid_send_output_report');
  late final _hid_send_output_report = _hid_send_output_reportPtr.asFunction<
      int Function(
          ffi.Pointer<hid_device>, ffi.Pointer<ffi.UnsignedChar>, int)>();

  /// @brief Get the error message for the last error which occurred.
  ///
  /// Since version 0.15.0, @ref HID_API_VERSION >= HID_API_MAKE_VERSION(0, 15, 0)
  ///
  /// This function returns a pointer to the error message string
  /// for the last error that occurred on the given device handle.
  ///
  /// @ingroup API
  /// @param dev A device handle returned from hid_open(),
  /// or NULL to get the last non-device-specific error.
  ///
  /// @returns
  /// A string describing the last error (if any), or NULL if no error occurred.
  ffi.Pointer<ffi.WChar> hid_read_error(
    ffi.Pointer<hid_device> dev,
  ) {
    return _hid_read_error(
      dev,
    );
  }

  late final _hid_read_errorPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.WChar> Function(
              ffi.Pointer<hid_device>)>>('hid_read_error');
  late final _hid_read_error = _hid_read_errorPtr
      .asFunction<ffi.Pointer<ffi.WChar> Function(ffi.Pointer<hid_device>)>();
